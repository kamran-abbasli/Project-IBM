...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                ...
                searchable=True
                                ...
                                dcc.RangeSlider(id='payload-slider',min=0,max=10000,marks={0:'0',100:'100'},value=[min_payload,max_payload]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # If 'ALL' sites are selected, show the total success (class=1) vs failure (class=0)
...
def get_scatter_chart(entered_site, payload_range):
    ...
    # If 'ALL' sites are selected, show a scatter plot for all sites
    if entered_site == 'ALL':
        fig = px.scatter(
            filtered_df, 
            x='Payload Mass (kg)', 
        ...
        # If a specific site is selected, filter for the selected site
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(
            filtered_df, 
            x='Payload Mass (kg)', 
